...
def Home():
    os.system("cls")
    colorama.init()
    ctypes.windll.kernel32.SetConsoleTitleW(f"Khamora Nitro Tool | Loading...")
    time.sleep(3)
    ctypes.windll.kernel32.SetConsoleTitleW(f"Khamora Nitro Tool | Main Menu")
    print(f'''
{Fore.LIGHTCYAN_EX}KHAMORA
{Fore.LIGHTCYAN_EX}                                             KHAMORA
{Fore.LIGHTCYAN_EX}                          KHAMORA
{Fore.LIGHTCYAN_EX}                 KHAMORA
{Fore.LIGHTCYAN_EX}        KHAMORA       
...
def Generator():
    os.system("cls")
    ctypes.windll.kernel32.SetConsoleTitleW(f"Khamora Nitro Generator and Checker")
    generated = 0

    print(f'''
                                                                                                                                                    
{Fore.LIGHTCYAN_EX}Khamora Nitro Generator and Checker
{Fore.LIGHTCYAN_EX}https://discord.gg/NjZhXxbJXb
    ''')

    num=input(f"[{Fore.LIGHTCYAN_EX}Enter The Ammount Of Codes You Want To Generate{Fore.LIGHTBLACK_EX}]{Fore.LIGHTCYAN_EX}> ")
    ...
    for kele in range(int(num)):
        ...
        ctypes.windll.kernel32.SetConsoleTitleW(f"Khamora Nitro Generator | Generated: %s" % generated)
        generated += 1
...
{Fore.LIGHTCYAN_EX}https://discord.gg/NjZhXxbJXb
    ...
    for line in f:
        ...
        if r.status_code == 200:
            ...
            break
            ctypes.windll.kernel32.SetConsoleTitleW(f"Khamora Nitro Code Checker | Checked: %s" % checked)
            checked += 1
        else:
...
webbrowser.open_new_tab("https://discord.gg/NjZhXxbJXb")
Home()
